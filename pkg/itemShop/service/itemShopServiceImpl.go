...
import (
	entities "github.com/Shiryuji/ryuji-shop-api/entities"
...
func (s *itemShopServiceImpl) toItemResultResponse(itemEntitiyList []*entities.Item, page, totalPage int64) *_itemShopModel.ItemResult {
	itemModelList := make([]*_itemShopModel.Item, 0)

	for _, item := range itemEntitiyList {
